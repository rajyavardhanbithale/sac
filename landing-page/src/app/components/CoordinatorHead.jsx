...
export default function CoordinatorHead() {
    return (
        <>
            <Title title={"Club Faculty Coordinator"}></Title>
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-12 mx-auto">
                    <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                        <div class="sm:w-1/2 mb-10 px-4">
                            <div class="h-64 overflow-hidden">
                                <img alt="content" class="rounded-xl object-cover object-top h-full w-3/4 mx-auto" src="faculty/head-om-prakash-sahu.jpeg" />
                            </div>
                        ...
                        <div class="sm:w-1/2 mb-10 px-4">
                            <div class="h-64 overflow-hidden">
                                <img alt="content" class="rounded-xl object-cover object-top h-full w-3/4 mx-auto" src="faculty/iec-sheetal-sharma.jpeg" />
                            </div>
